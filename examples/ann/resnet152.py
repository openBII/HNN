...
def qresnet152(batch_norm: bool = False, **kwargs: Any) -> QResNet:
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _qresnet(Bottleneck, [3, 8, 36, 3], batch_norm=batch_norm, **kwargs)


if __name__ == '__main__':
    model = qresnet152()
    model.execute(is_random_input=True, fix_random_seed=True,
                  result_path='temp/QResNet152/o_0_0_0.dat', export_onnx_path='temp/QResNet152/QResNet152.onnx')
