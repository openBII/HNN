...
class SNNVGG19(QModel):
    def __init__(self, T=10, num_classes=1000):
        super(SNNVGG19, self).__init__(time_window_size=T)
    ...
    def forward(self, x: torch.Tensor):
        ...
        v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v_fc0, v_fc1, v_fc2 = None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None
        x_copy = x
        for i in range(self.T):
            ...
            x, q = self.conv13(x)
            out, v13 = self.lif13(x, q, v13)
            x = self.relu(out)

            x, q = self.conv14(x)
            out, v14 = self.lif14(x, q, v14)
            x = self.relu(out)

            x, q = self.conv15(x)
            out, v15 = self.lif15(x, q, v15)
            x = self.relu(out)
            x = self.maxpool4(x)
...
if __name__ == '__main__':
    ...
    torch.onnx.export(model, x, 'temp/SNNVGG19.onnx',
